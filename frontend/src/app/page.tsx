...
import { FaHandshake, FaUsers, FaBuilding, FaArrowRight, FaMapMarkerAlt, FaDollarSign, FaCalendarAlt, FaUser, FaBriefcase, FaHome } from 'react-icons/fa';
...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [dealsRes, peopleRes, propertiesRes] = await Promise.all([
